        ...
        {recetasFiltradas.map((receta) => (
          <Grid size={{xs:12, sm:6, md:4}}  key={receta.id_receta}>
            ...
            >
              ...
              <CardActions>
                <Button size="small" onClick={() => {recetaExpandida != receta.id_receta ?  (toggleExpand(receta.id_receta), actualizarRatingUI(receta.id_receta)) : toggleExpand(receta.id_receta) }}>
